...
function intemClick(type) {
  switch (type) {
    case "matching":
      document.getElementById("content").innerHTML = "<iframe width='900' height='580' scrolling='no' frameborder='0' src=\"content/matching.htm\"></iframe>";
      console.log("matching's clicked!");
    break;
    case "muilple_choice":
      document.getElementById("content").innerHTML = "<iframe width='900' height='580' scrolling='no'  frameborder='0' src=\"content/multiple-choice.htm\"></iframe>";
    break;
    case "crossword":
    document.getElementById("content").innerHTML = "<iframe width='900' height='580' scrolling='no' frameborder='0' src=\"content/crossword.htm\"></iframe>";
